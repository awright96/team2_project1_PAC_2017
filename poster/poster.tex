...
\begin{textblock}{11.2}(0,4)
	...
	\LHead{\parbox{11.2in}{\begin{center}\textcolor{WolfpackRed}{Q}Motivation and Use Cases \textcolor{WolfpackRed}{Q}\end{center}}}\\ %*2*
	
	% We're inputting content about graphs in general
	%\begin{multicols}{2}
	\input{tex/motivations.tex}
...
%                    Problem
%***************************************************************
\begin{textblock}{11.2}(0,21.5)
	% This is a header
	% We defined it above to use the Wolfpack Red color
	% To make sure all headers are the same height, we hid two "Q"s in the header
	% We hid them by coloring them with Wolfpack Red
	\LHead{\parbox{11.2in}{\begin{center}\textcolor{WolfpackRed}{Q}Problem Definition \textcolor{WolfpackRed}{Q}\end{center}}}\\ %*2*
...
\begin{textblock}{11}(11.75,12)
\LHead{\parbox{11.25in}{\begin{center}\textcolor{WolfpackRed}{Q}Related Work\textcolor{WolfpackRed}{Q}\end{center}}}\\ %*2*
...
%This places a block on the right hand side
\begin{textblock}{11.2}(11.75,4)
	\LHead{\parbox{11in}{\begin{center}\textcolor{WolfpackRed}{Q}Definitions\textcolor{WolfpackRed}{Q}\end{center}}}\\ %*2*
...
\begin{textblock}{11.2}(11.75,30.5)
	\Large \textbf{Reference} \centering
\end{textblock}
